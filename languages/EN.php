...
$MOD_NEWS_IMG['NEWSLETTER_ERROR_NEWS_NOT_ACTIVE'] = 'This post is not active or not yet / no longer online and therefore cannot be sent as a newsletter';
$MOD_NEWS_IMG['NEWSLETTER_SEND_OUT'] = 'Send out as newsletter';
$MOD_NEWS_IMG['NEWSLETTER_HAS_BEEN_SENT_OUT'] = 'This post was already sent out as newsletter. Re-activate only if you want the newsletter to be sent out AGAIN!';
$MOD_NEWS_IMG['NEWSLETTER_HAS_NOT_BEEN_SENT_OUT'] = 'Post has not yet been sent as a newsletter.';
