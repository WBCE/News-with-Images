...
$MOD_NEWS_IMG['REFRESH_ACCESS_FILES'] = 'Rigenera file di accesso';
$MOD_NEWS_IMG['REFRESH_ACCESS_FILES_CONFIRM'] = 'Riscrivere i file di accesso per tutti i post di questa sezione?';
$MOD_NEWS_IMG['REFRESH_ACCESS_FILES_TOOLTIP'] = 'Ricrea i file di accesso per tutti i post di questa sezione — utile dopo importazioni o in caso di link non funzionanti.';
$MOD_NEWS_IMG['REFRESH_ACCESS_FILES_SUCCESS'] = '%d file di accesso rigenerati';
$MOD_NEWS_IMG['REFRESH_ACCESS_FILES_FAILED'] = "%d file di accesso non sono stati rigenerati";
$MOD_NEWS_IMG['DEMODATA_IMPORT'] = 'Importa dati dimostrativi';
$MOD_NEWS_IMG['DEMODATA_IMPORT_INFO'] = "Questa sezione &egrave; ancora vuota. Puoi importare qui dei post di esempio per provare il layout. L'opzione scompare non appena la sezione contiene propri post o gruppi.";
$MOD_NEWS_IMG['DEMODATA_PACK'] = 'Pacchetto dati';
$MOD_NEWS_IMG['DEMODATA_IMPORT_BUTTON'] = 'Importa';
$MOD_NEWS_IMG['DEMODATA_CONFIRM'] = 'Vuoi davvero importare i dati dimostrativi in questa sezione?';
$MOD_NEWS_IMG['DEMODATA_IMPORT_SUCCESS'] = 'Dati dimostrativi importati';
$MOD_NEWS_IMG['DEMODATA_IMPORT_FAILED'] = 'Importazione dati dimostrativi fallita';
$MOD_NEWS_IMG['DEFAULT_PREVIEW_IMAGE'] = 'Immagine predefinita';
$MOD_NEWS_IMG['DEFAULT_PREVIEW_IMAGE_NONE_SET'] = 'nessuna immagine predefinita impostata';
$MOD_NEWS_IMG['DEFAULT_PREVIEW_IMAGE_UPLOAD'] = 'Carica nuova immagine';
$MOD_NEWS_IMG['DEFAULT_PREVIEW_IMAGE_PICK_EXISTING'] = 'scegli da immagini dei post esistenti';
$MOD_NEWS_IMG['DEFAULT_PREVIEW_IMAGE_REMOVE'] = 'rimuovi';
$MOD_NEWS_IMG['DEFAULT_PREVIEW_IMAGE_SEARCH'] = 'cerca...';
$MOD_NEWS_IMG['NO_IMAGES_AVAILABLE'] = 'Nessuna immagine &egrave; ancora stata caricata per questa sezione.';
$MOD_NEWS_IMG['DELETE'] = "elimina";
$MOD_NEWS_IMG['DELETEIMAGE'] = 'Elimina questa immagine?';
$MOD_NEWS_IMG['DESCENDING'] = 'asteso'; 
$MOD_NEWS_IMG['EXPERT_MODE'] = 'modalit� esperto'; 
...
$MOD_NEWS_IMG['INFO_RELOAD_PAGE'] = "Questo ricaricher� la pagina; tutti i dati non salvati andranno persi!"; 
...
$MOD_NEWS_IMG['NEWEST_FIRST'] = 'il pi� recente in alto'; 
...
$MOD_NEWS_IMG['POST_ACTIVE'] = 'Il messaggio � visibile'; 
$MOD_NEWS_IMG['POST_CONTENT'] = 'Pubblica contenuto';
$MOD_NEWS_IMG['POST_INACTIVE'] = 'Il messaggio non � visibile'; 
...
$MOD_NEWS_IMG['TAG_TEXT_COLOR'] = 'Colore testo';
$MOD_NEWS_IMG['TAG_EXISTS'] = 'Il tag esiste';
$MOD_NEWS_IMG['TAGS'] = 'tag'; 
$MOD_NEWS_IMG['TAGS_INFO'] = 'Per utilizzare i tag, modifica un post e seleziona l� i tag desiderati.'; 
$MOD_NEWS_IMG['TO'] = "a";
