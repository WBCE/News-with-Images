...
$MOD_NEWS_IMG['REFRESH_ACCESS_FILES'] = 'Recriar arquivos de acesso';
$MOD_NEWS_IMG['REFRESH_ACCESS_FILES_CONFIRM'] = 'Recriar os arquivos de acesso de todos os posts desta seção?';
$MOD_NEWS_IMG['REFRESH_ACCESS_FILES_TOOLTIP'] = 'Recria os arquivos de acesso de todos os posts desta seção — útil após importações ou com links quebrados.';
$MOD_NEWS_IMG['REFRESH_ACCESS_FILES_SUCCESS'] = '%d arquivo(s) de acesso recriado(s)';
$MOD_NEWS_IMG['REFRESH_ACCESS_FILES_FAILED'] = '%d arquivo(s) de acesso não puderam ser recriados';
$MOD_NEWS_IMG['DEMODATA_IMPORT'] = 'Importar dados de demonstração';
$MOD_NEWS_IMG['DEMODATA_IMPORT_INFO'] = 'Esta seção ainda está vazia. Aqui você pode importar posts de exemplo para experimentar o layout. A opção desaparece assim que a seção contém seus próprios posts ou grupos.';
$MOD_NEWS_IMG['DEMODATA_PACK'] = 'Pacote de dados';
$MOD_NEWS_IMG['DEMODATA_IMPORT_BUTTON'] = 'Importar';
$MOD_NEWS_IMG['DEMODATA_CONFIRM'] = 'Realmente importar dados de demonstração para esta seção?';
$MOD_NEWS_IMG['DEMODATA_IMPORT_SUCCESS'] = 'Dados de demonstração importados';
$MOD_NEWS_IMG['DEMODATA_IMPORT_FAILED'] = 'Falha na importação dos dados de demonstração';
$MOD_NEWS_IMG['DEFAULT_PREVIEW_IMAGE'] = 'Imagem padrão';
$MOD_NEWS_IMG['DEFAULT_PREVIEW_IMAGE_NONE_SET'] = 'nenhuma imagem padrão definida';
$MOD_NEWS_IMG['DEFAULT_PREVIEW_IMAGE_UPLOAD'] = 'Enviar nova imagem';
$MOD_NEWS_IMG['DEFAULT_PREVIEW_IMAGE_PICK_EXISTING'] = 'escolher entre as imagens de posts existentes';
$MOD_NEWS_IMG['DEFAULT_PREVIEW_IMAGE_REMOVE'] = 'remover';
$MOD_NEWS_IMG['DEFAULT_PREVIEW_IMAGE_SEARCH'] = 'pesquisar...';
$MOD_NEWS_IMG['NO_IMAGES_AVAILABLE'] = 'Nenhuma imagem foi enviada ainda para esta seção.';
